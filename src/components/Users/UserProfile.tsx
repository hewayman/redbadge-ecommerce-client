...
interface UserProfileState extends User {
  // user: User[]; // not sure if this is right
  active: boolean;
}
                ...
                <Card>
                  ...
                  <CardContent style={{paddingLeft: '5px', paddingTop:'5px'}}>
                    <Typography variant="body2" color="textSecondary" component="p" style={{ fontFamily:'Montserrat', fontSize:'1.3em', color:'black' }}>
                      {this.state.firstName || this.props.user!.firstName} {this.state.lastName || this.props.user!.lastName}
                    </Typography>
                    <Typography variant="body2" color="textSecondary" component="p" style={{ fontFamily:'Montserrat' }}>
                      ...
                      <br/>
                      <b>Address Line 1: </b> {this.state.addressLn1 || this.props.user!.addressLn1}
                      <br/>
                      <b>Address Line 2: </b> {this.state.addressLn2 || this.props.user!.addressLn2}
                      <br/>
                      <b>City: </b> {this.state.city || this.props.user!.city}
                      <br/>
                      <b>State: </b> {this.state.state || this.props.user!.state}
                      <br/>
                      <b>Zip Code: </b> {this.state.zipcode || this.props.user!.zipcode}
                    </Typography>
                  </CardContent>
                </Card>
              </Container>
